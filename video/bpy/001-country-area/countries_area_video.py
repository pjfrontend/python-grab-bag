...
files_names = [
    "../utils.py",
    "../utils_bpy.py",
    "countries_area_km2.py",
    "countries_area_mi2.py",
]
...
for index, item in enumerate(data_km2):
    ...
    txt = add_text(
        "{}: {}km2 / {}mi2".format(key, "{:,}".format(value), "{:,}".format(value2)),
        align_x="LEFT",
...
frames_in_sec = 24
duration_in_secs = 4 + len(data_km2) * 2
...
update_position(cam, (0, (text_or_bar_height * 2) * (len(data_km2) - 3), 0))
