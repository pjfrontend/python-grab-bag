data = [
    ...
    ("Sweden", 10612086),
    ("Honduras", 10593798),
    ("Czech Republic (Czechia)", 10495295),
    ("Azerbaijan", 10412651),
    ("Greece", 10341277),
    ...
    ("Seychelles", 107660),
    ("Aruba", 106277),
    ("St. Vincent and Grenadines", 103698),
